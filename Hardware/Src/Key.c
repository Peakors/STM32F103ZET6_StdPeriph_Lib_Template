...
unsigned char  KEYScanFunction(void)
{
	...
	Count++;
	//判定按下
	if((Free_Flag==0)&&((!(GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)))||(!(GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_4)))||(!(GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_3)))||((GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)))))
	{
	...
	//松手操作
	else if((Free_Flag==1)&&((GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)))&&((GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_4)))&&((GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_3)))&&(!(GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2))))
	{
		Free_Flag= 0;
		Count = 0;
	}
